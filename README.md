# Enhanced Rock Weathering - São Miguel Island, Azores

**Research Focus:** Carbon dioxide removal potential using volcanic basalt on São Miguel Island
...
**Location:** São Miguel, Azores Archipelago, Portugal  
...
- **Full ERW scenario:** 1.7-4.4 tCO₂/ha/yr (aggressive)
- **Weathering rate multiplier:** 4.6-11.7x baseline (EXCEPTIONAL)
- **11-plot pilot total:** 37-68 tCO₂/yr

### Economic Viability
- **Current practice:** €120/ha/yr (imported dolomitic lime)
...
- **At 50% adoption (7,500 ha):**
  - Annual basalt demand: 20,250 tonnes
  - CO₂ removal: 9,000-12,750 tCO₂/year
  - Cost savings: €637,500/year
  - Carbon revenue: €1,020,000/year
  - **Total benefit: €1.66 million/year**
...
python3 scripts/viability_analysis_simple.py
```

**Output:** Comprehensive viability assessment based on real soil data
- Viability scores for 11 plots (77-92/100)
- CO₂ removal potential (1.2-2.4 t/ha/yr)
- Economic analysis (€221/ha/yr benefit)
- Top 3 priority plots for pilot project

### 2. Run Island-Scale Resource Assessment

```bash
python3 case_studies/sao_miguel.py
```

**Output:** Complete island-scale ERW resource and CDR assessment
...
✓ Assessment complete! São Miguel has excellent ERW potential.
```
...
1. **Abundant young basalts** (Quaternary volcanic flows, high reactivity)
2. **Optimal climate** (2,500 mm rainfall, 17.5°C temperature)
3. **Extensive dairy agriculture** (250 km² pastures, ERW co-benefits)
4. **Island sustainability goals** (carbon neutrality commitments)
5. **Well-studied geology** (extensive scientific literature)
...
**Target Journals:**
- *Frontiers in Climate* (CDR section)
...
### São Miguel-Specific
- Guest et al. (1999) - Volcanic evolution of São Miguel, Azores
- Queiroz et al. (2015) - Fogo volcano eruption history
- Madeira et al. (2007) - Soils of volcanic systems in Portugal (Azores)
- Azevedo (1996) - Climate of the Azores

### ERW General
- Beerling et al. (2020), *Nature* - Global ERW potential
- Gislason & Oelkers (2003), *Chemical Geology* - Basalt weathering kinetics
- Kantola et al. (2017), *PLOS ONE* - Agricultural ERW deployment

**Full reference list:** See `research/literature.md`
...
- **Location:** Central São Miguel dairy farm
- **Size:** 10-20 hectares
- **Basalt application:** 50 tonnes/hectare
- **Duration:** 3 years monitoring
- **Budget:** €50,000-75,000
- **Expected CDR:** 300-500 tCO₂

**Partners:** University of Azores, local dairy cooperative, regional government
...
- Canary Islands
- Cape Verde
- Pacific volcanic islands (Hawaii, Fiji, Samoa)
- Caribbean volcanic arc

**Global potential:** 100+ volcanic islands → 1-5 MtCO₂/year CDR

---

## 📞 Contact & Collaboration

This is an open research project. Collaboration welcome from:
- Azorean dairy farmers
- University of Azores researchers
- Regional government (sustainability initiatives)
...
MIT License - This research framework is open source for academic and commercial use.
...
- ⏳ **Manuscript draft** (Ready to begin)
